# CUDA_VISIBLE_DEVICES=6 python -m xg.demos.sql_demo
...
if __name__ == "__main__":
    ...
    USER_PROMPT = "Define a set of tables for tracking students, classes, and grades at UCLA."
